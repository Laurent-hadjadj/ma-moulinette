...
$('.js-modifier-analyse').on('click', function () {
  const poubelle=`<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 512 512"
                  class="poubelle-svg" preserveAspectRatio="xMidYMid meet">
