 ...
 */
      ...
      `<div class="small-12 medium-12 large-6 cell">
        <div class="callout secondary box-langage">
          ...
          <p class="button expanded float-center bouton-profil-refresh js-bouton-autre-profil" data-language="${profil.langage}" id="language-${profil.langage}">
            <button class="open-sans color-blanc">Afficher les autres profils</button>
          </p>
        </div>
      </div>`
  ...
  str_total=`<p class="open-sans">Le référentiel des règles de développement contient
          <strong><span class="js-total">${new Intl.NumberFormat('fr-FR', { style: 'decimal' }).format(total)}</span></strong> règles.</p>`
