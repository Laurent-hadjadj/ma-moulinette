...
function remplissage_hotspot_info(id_maven) {
 ...
 $('#hotspot-to-review').html(new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.to_review)); sessionStorage.setItem('hotspot-to-review', r.to_review);
  ...
  let hotspot_total=parseInt(sessionStorage.getItem('hotspot-total'));
  if ( hotspot_total !=0 ) {
    leTaux = 1 - (parseInt(sessionStorage.getItem('hotspot-to-review')) / hotspot_total);
...
function remplissage_hotspot_liste(id_maven) {
  ...
  if ( hotspot_total !=0 )
  {
    ...
    //A2
    leTaux = 1 - (parseInt(r.menace_a2)/ hotspot_total);
    _note = calcul_note_hotspot(leTaux);
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    ...
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    if ( leTaux*100==100) { espace="&nbsp;"}
    i = '<span class="stat-note">'+ new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.menace_a3) +'</span><span class="stat-note">' + espace + new Intl.NumberFormat('fr-FR', { style: 'percent', }).format(leTaux) + '</span> <span class="badge ' + _note[0] + '">' + _note[1] + '</span>';
    $('#h3').html(i);
    ...
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    if ( leTaux*100==100) { espace="&nbsp;"}
    i = '<span class="stat-note">'+new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.menace_a4) +'</span><span class="stat-note">' + espace + new Intl.NumberFormat('fr-FR', { style: 'percent', }).format(leTaux) + '</span> <span class="badge ' + _note[0] + '">' + _note[1] + '</span>';
    $('#h4').html(i);
    ...
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    if ( leTaux*100==100) { espace="&nbsp;"}
    i = '<span class="stat-note">'+new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.menace_a5) +'</span><span class="stat-note">' + espace + new Intl.NumberFormat('fr-FR', { style: 'percent', }).format(leTaux) + '</span> <span class="badge ' + _note[0] + '">' + _note[1] + '</span>';
    $('#h5').html(i);
    ...
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    if ( leTaux*100==100) { espace="&nbsp;"}
    i = '<span class="stat-note">'+new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.menace_a6) +'</span><span class="stat-note">' + espace + new Intl.NumberFormat('fr-FR', { style: 'percent', }).format(leTaux) + '</span> <span class="badge ' + _note[0] + '">' + _note[1] + '</span>';
    $('#h6').html(i);
    ...
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    if ( leTaux*100==100) { espace="&nbsp;"}
    i = '<span class="stat-note">'+new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.menace_a7) +'</span><span class="stat-note">'+ espace + new Intl.NumberFormat('fr-FR', { style: 'percent', }).format(leTaux) + '</span> <span class="badge ' + _note[0] + '">' + _note[1] + '</span>';
    $('#h7').html(i);
    ...
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    if ( leTaux*100==100) { espace="&nbsp;"}
    i = '<span class="stat-note">'+new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.menace_a8) +'</span><span class="stat-note">' + espace + new Intl.NumberFormat('fr-FR', { style: 'percent', }).format(leTaux) + '</span> <span class="badge ' + _note[0] + '">' + _note[1] + '</span>';
    $('#h8').html(i);
    ...
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    if ( leTaux*100==100) { espace="&nbsp;"}
    i = '<span class="stat-note">'+new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.menace_a9) +'</span><span class="stat-note">' + espace +  new Intl.NumberFormat('fr-FR', { style: 'percent', }).format(leTaux) + '</span> <span class="badge ' + _note[0] + '">' + _note[1] + '</span>';
    $('#h9').html(i);
    ...
    if ( (leTaux*100)>10 && (leTaux*100)<100) { espace="&nbsp;&nbsp;&nbsp;"} else {espace="";}
    if ( leTaux*100==100) { espace="&nbsp;"}
    i = '<span class="stat-note">'+new Intl.NumberFormat('fr-FR', { style: 'decimal', }).format(r.menace_a10) +'</span><span class="stat-note">' + espace + new Intl.NumberFormat('fr-FR', { style: 'percent', }).format(leTaux) + '</span> <span class="badge ' + _note[0] + '">' + _note[1] + '</span>';
    $('#h10').html(i);
   }
  else
  {
...
$('.js-details').on('click', function () {
  ...
  let _key=localStorage.getItem('projet');
...
let key=localStorage.getItem('projet');
let projet=key.split(":");
