...
class BoardController extends AbstractController
{
  ...
  */
  ...
  public function suivi_mise_a_jour(EntityManagerInterface $em, Request $request)
  {
    ...
    //VALUES ('fr.ma-moulinette:projet-hub','4.1.20-RELEASE','05-01-2022 08:41:00','projet-hub',0,0,0,0,50870,25506,0.0,2.6,0,4167,48011,148,7,4012,0,0,0,0,0,0,0,0,'C','C','C','E',5,0,0,0,1,FALSE,'2022-03-27 16:03:21')
