...
class Batch
{
    ...
    /* MODIF 2026-05-07 : init traitementId + dateEnregistrement (sinon must not be accessed before initialization). */
    public function __construct()
    {
        $this->activated = false;
        $this->responsable = 'John Doe';
        $this->responsableShort = 'JD';
