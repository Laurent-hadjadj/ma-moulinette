...
/**
 * [Description PortefeuilleRepositoryHandlerTest]
 */
class PortefeuilleRepositoryHandlerTest extends TestCase
{
    public function testSelectPortefeuille_WhenSQLException(): void
    {
        ...
        $repo = $this->getMockBuilder(PortefeuilleRepository::class)
        ...
        // MODIF 2026-06-10 — clé groupe_fonctionnel depuis refonte CRUD
        $map = ['groupe_fonctionnel' => 'exemple-de-projets'];
        $result = $repo->selectPortefeuille($map);
