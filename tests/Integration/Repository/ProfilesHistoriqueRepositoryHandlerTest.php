...
/**
 * [Description ProfilesHistoriqueRepositoryHandlerTest]
 */
class ProfilesHistoriqueRepositoryHandlerTest extends TestCase
{
    ...
    public function testSelectProfilesHistoriqueAction_WhenSQLException(): void
    {
        ...
        // pour couvrir selectProfilesHistoriqueDateTri refactorée.
        ...
        $repo = $this->getMockBuilder(ProfilesHistoriqueRepository::class)
    ...
    public function testSelectProfilesHistoriqueDateTri_WhenSQLException(): void
    {
        // 1) Exception DBAL factice
        $fakeException = $this->createStub(DBALException::class);
    ...
    public function testSelectProfilesHistoriqueDateCourteGroupeBy_WhenSQLException(): void
    {
        // 1) Exception DBAL factice
        $fakeException = $this->createStub(DBALException::class);
    ...
    public function testSelectProfilesHistoriqueLangageDateCourte_WhenSQLException(): void
    {
        // 1) Exception DBAL factice
        $fakeException = $this->createStub(DBALException::class);
    ...
    public function testInsertProfilesHistorique_WhenSQLException(): void
    {
