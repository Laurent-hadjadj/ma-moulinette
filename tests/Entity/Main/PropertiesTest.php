...
class PropertiesTest extends TestCase
{
  ...
  public function testPropertiesCount(): void
  {
    ...
    /**
   * [Description for testPropertiesCountAttribut]
   ...
   * @copyright Licensed Ma-Moulinette - Creative Common CC-BY-NC-SA 4.0.
   */
  public function testPropertiesCountAttribut(): void
  {
    /** On récupère le jeu de données */
    $d=static::dataset();

    $mockRepo = $this->createMock(Properties::class);
    /**
  ...
  /**
   * [Description for testPropertiesType]
   * On vérifie le type
   * @return void
   *
   * Created at: 14/02/2023, 15:29:37 (Europe/Paris)
   * @author     Laurent HADJADJ <laurent_h@me.com>
   * @copyright Licensed Ma-Moulinette - Creative Common CC-BY-NC-SA 4.0.
   */
