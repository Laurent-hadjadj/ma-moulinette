...
/**
 * [Description ActiviteKernelTest]
 */
class ActiviteKernelTest extends KernelTestCase
{
    ...
    public function testActiviteFindOneBy(): void
    {
    ...
    public function testActiviteCount(): void
    {
        /* On se connecte à la base de tests */
        $container = static::getContainer();
        $entityManager = $container->get('doctrine')->getManager();
