...
/**
 * [Description MesuresRepositoryHandlerTest]
 */
class MesuresRepositoryHandlerTest extends TestCase
{
    private static $mavenKey = 'fr.ma-petite-entreprise:ma-moulinette';
    private static $gestionTest = 'gestion test';

    public function testSelectMesuresVersionLast_WhenSQLException(): void
    {
        ...
        $repo = $this->getMockBuilder(MesuresRepository::class)
    ...
    public function testInsertMesures_WhenSQLException(): void
    {
        ...
        $result = $repo->insertMesures($map);

        $this->assertSame($expected, $result);
    }

    public function testDeleteMesuresMavenKey_WhenSQLException(): void
    {
        // 1) Crée une vraie exception qui implémente DBAL\Exception et Throwable
