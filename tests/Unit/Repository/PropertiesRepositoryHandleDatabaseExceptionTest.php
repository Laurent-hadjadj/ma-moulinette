...
/**
 * [Description PropertiesRepositoryHandleDatabaseExceptionTest]
 */
class PropertiesRepositoryHandleDatabaseExceptionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new PropertiesRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new PropertiesRepository($managerRegistryMock);
