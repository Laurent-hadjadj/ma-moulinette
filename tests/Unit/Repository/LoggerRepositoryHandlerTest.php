...
/**
 * [Description LoggerRepositoryHandlerTest]
 */
class LoggerRepositoryHandlerTest extends TestCase
{
    private static $mavenKey = 'fr.ma-petite-entreprise:ma-moulinette';
    private static $gestionTest = 'gestion test';

    public function testSelectLoggerIsValide_WhenSQLException(): void
    {
        ...
        $repo = $this->getMockBuilder(LoggerRepository::class)
        ...
        $result = $repo->selectLoggerIsValide($map);

        // 9) Vérification
        $this->assertSame($expected, $result);
    }

    public function testSelectLogger_WhenSQLException(): void
    {
        // 1) Exception DBAL factice
        /** @var DBALException&\Throwable $fakeException */
        $fakeException = $this->createMock(DBALException::class);
    ...
    public function testInsertLogger_WhenSQLException(): void
    {
        ...
        $result = $repo->insertLogger($map);

        $this->assertSame($expected, $result);
    }

    public function testDeleteLoggerMavenKey_WhenSQLException(): void
    {
        // 1) Crée une vraie exception qui implémente DBAL\Exception et Throwable
