...
/**
 * [Description OwaspTop10RepositoryHandleDatabaseExceptionTest]
 */
class OwaspTop10RepositoryHandleDatabaseExceptionTest extends TestCase
{
    private OwaspTop10Repository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new OwaspTop10Repository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new OwaspTop10Repository($managerRegistryMock);
