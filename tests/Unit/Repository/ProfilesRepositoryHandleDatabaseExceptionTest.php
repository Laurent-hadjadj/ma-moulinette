...
/**
 * [Description ProfilesRepositoryHandleDatabaseExceptionTest]
 */
class ProfilesRepositoryHandleDatabaseExceptionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new ProfilesRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new ProfilesRepository($managerRegistryMock);
