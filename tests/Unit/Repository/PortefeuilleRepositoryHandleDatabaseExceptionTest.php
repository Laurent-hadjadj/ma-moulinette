...
/**
 * [Description PortefeuilleRepositoryHandleDatabaseExceptionTest]
 */
class PortefeuilleRepositoryHandleDatabaseExceptionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new PortefeuilleRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new PortefeuilleRepository($managerRegistryMock);
