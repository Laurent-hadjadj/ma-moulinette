...
/**
 * [Description ActivityRepositoryHandleDatabaseExceptionTest]
 */
class ActivityRepositoryHandleDatabaseExceptionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new ActivityRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new ActivityRepository($managerRegistryMock);
