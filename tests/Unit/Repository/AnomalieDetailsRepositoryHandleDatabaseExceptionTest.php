...
/**
 * [Description AnomalieDetailsRepositoryHandleDatabaseExceptionTest]
 */
class AnomalieDetailsRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private AnomalieDetailsRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new AnomalieDetailsRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new AnomalieDetailsRepository($managerRegistryMock);
