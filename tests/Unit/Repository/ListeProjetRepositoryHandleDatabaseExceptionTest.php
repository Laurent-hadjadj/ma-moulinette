...
/**
 * [Description ListeProjetRepositoryHandleDatabaseExceptionTest]
 */
class ListeProjetRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private ListeProjetRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new ListeProjetRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new ListeProjetRepository($managerRegistryMock);
