...
/**
 * [Description HotspotDetailsRepositoryHandleDatabaseExceptionTest]
 */
class HotspotDetailsRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private HotspotDetailsRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new HotspotDetailsRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new HotspotDetailsRepository($managerRegistryMock);
