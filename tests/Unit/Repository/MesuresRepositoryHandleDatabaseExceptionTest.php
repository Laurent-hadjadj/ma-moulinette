...
/**
 * [Description MesuresRepositoryHandleDatabaseExceptionTest]
 */
class MesuresRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private MesuresRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new MesuresRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new MesuresRepository($managerRegistryMock);
