...
/**
 * [Description ActivityRepositoryHandlerTest]
 */
class ActivityRepositoryHandlerTest extends TestCase
{

  public function testSelectActivity_WhenSQLException(): void
  {
    ...
    $repo = $this->getMockBuilder(ActivityRepository::class)
    ...
    $result = $repo->selectActivity(2025);

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testInsertActivity_WhenSQLException(): void
  {
    ...
    $map = [
            [
              ...
              'submitted_at' => new \DateTimeImmutable('2024-07-31 12:26:58+02'),
              'started_at' => new \DateTimeImmutable('2024-07-31 12:27:05+02'),
              'executed_at' => new \DateTimeImmutable('2024-07-31 12:27:47+02'),
              'execution_time' => 42
            ]
          ];
    // 9) Appel de la méthode : elle doit entrer dans le catch et renvoyer $expected
    $result = $repo->insertActivity($map);

    $this->assertSame($expected, $result);
  }

  public function testNombreJourAnneeDonnee_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->nombreJourAnneeDonnee(2025);

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testTempsExecutionMax_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->tempsExecutionMax(2025);

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testNombreStatus_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->nombreStatus(2025, 'SUCCESS');

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testNombreAnalyse_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->nombreAnalyse(2025);

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testDernierDate_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->dernierDate(2025);

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testPremiereDate_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->premiereDate(2025);

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testListeProjectAnalyse_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->listeProjectAnalyse(2025);

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testListeAnalyseJour_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->listeAnalyseJour(2025);

    // 9) Vérification
    $this->assertSame($expected, $result);
  }

  public function testListeAnalyseProjet_WhenSQLException(): void
  {
    // 1) Exception DBAL factice
    /** @var DBALException&\Throwable $fakeException */
    $fakeException = $this->createMock(DBALException::class);
    ...
    // 8) Appel de la méthode
    $result = $repo->listeAnalyseProjet(2025);
