...
/**
 * [Description HistoriqueRepositoryHandleDatabaseExceptionTest]
 */
class HistoriqueRepositoryHandleDatabaseExceptionTest extends TestCase
{
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new HistoriqueRepository($managerRegistryMock);
