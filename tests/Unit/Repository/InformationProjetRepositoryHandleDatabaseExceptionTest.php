...
/**
 * [Description InformationProjetRepositoryHandleDatabaseExceptionTest]
 */
class InformationProjetRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private InformationProjetRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new InformationProjetRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new InformationProjetRepository($managerRegistryMock);
