...
/**
 * [Description HotspotsRepositoryHandlerTest]
 */
class HotspotsRepositoryHandlerTest extends TestCase
{
    private static $mavenKey = 'fr.ma-petite-entreprise:ma-moulinette';
    private static $gestionTest = 'gestion test';

    public function testSelectHotspotsToReview_WhenSQLException(): void
    {
        ...
        $repo = $this->getMockBuilder(HotspotsRepository::class)
        ...
        $result = $repo->selectHotspotsToReview($map);

        // 9) Vérification
        $this->assertSame($expected, $result);
    }

    public function testCountHotspotsStatus_WhenSQLException(): void
    {
        // 1) Exception DBAL factice
        /** @var DBALException&\Throwable $fakeException */
        $fakeException = $this->createMock(DBALException::class);
        ...
        // 8) Appel de la méthode
        $map = ['maven_key' => static::$mavenKey, 'status' => 'REVIEW'];
        $result = $repo->countHotspotsStatus($map);

        // 9) Vérification
        $this->assertSame($expected, $result);
    }

    public function testSelectHotspotsByNiveau_WhenSQLException(): void
    {
        // 1) Exception DBAL factice
        /** @var DBALException&\Throwable $fakeException */
        $fakeException = $this->createMock(DBALException::class);
        ...
        // 8) Appel de la méthode
        $map = ['maven_key' => static::$mavenKey, 'status' => 'REVIEW'];
        $result = $repo->selectHotspotsByNiveau($map);

        // 9) Vérification
        $this->assertSame($expected, $result);
    }

    public function testInsertHotspots_WhenSQLException(): void
    {
        ...
        $result = $repo->insertHotspots($map);

        $this->assertSame($expected, $result);
    }

    public function testDeleteHotspotsMavenKey_WhenSQLException(): void
    {
        // 1) Crée une vraie exception qui implémente DBAL\Exception et Throwable
        ...
        // 9) Appel de la méthode : elle doit entrer dans le catch et renvoyer $expected
        $result = $repo->deleteHotspotsMavenKey($map);
