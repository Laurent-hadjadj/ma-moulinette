...
/**
 * [Description AnomalieRepositoryHandleDatabaseExceptionTest]
 */
class AnomalieRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private AnomalieRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new AnomalieRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new AnomalieRepository($managerRegistryMock);
