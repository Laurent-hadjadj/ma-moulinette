...
/**
 * [Description OwaspRepositoryHandleDatabaseExceptionTest]
 */
class OwaspRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private OwaspRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new OwaspRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new OwaspRepository($managerRegistryMock);
