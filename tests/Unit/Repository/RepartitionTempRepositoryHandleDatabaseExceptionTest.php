...
/**
 * [Description RepartitionTempRepositoryHandleDatabaseExceptionTest]
 */
class RepartitionTempRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private RepartitionTempRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new RepartitionTempRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new RepartitionTempRepository($managerRegistryMock);
