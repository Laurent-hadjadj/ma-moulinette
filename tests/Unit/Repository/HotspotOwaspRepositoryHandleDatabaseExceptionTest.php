...
/**
 * [Description HotspotOwaspRepositoryHandleDatabaseExceptionTest]
 */
class HotspotOwaspRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private HotspotOwaspRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new HotspotOwaspRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new HotspotOwaspRepository($managerRegistryMock);
