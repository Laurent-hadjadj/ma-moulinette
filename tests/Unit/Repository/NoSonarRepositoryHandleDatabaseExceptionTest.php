...
/**
 * [Description NoSonarRepositoryHandleDatabaseExceptionTest]
 */
class NoSonarRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private NoSonarRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new NoSonarRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new NoSonarRepository($managerRegistryMock);
