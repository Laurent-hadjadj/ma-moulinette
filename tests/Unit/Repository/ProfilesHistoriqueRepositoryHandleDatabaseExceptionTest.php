...
/**
 * [Description ProfilesHistoriqueRepositoryHandleDatabaseExceptionTest]
 */
class ProfilesHistoriqueRepositoryHandleDatabaseExceptionTest extends TestCase
{
    private ProfilesHistoriqueRepository $repo;
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new ProfilesHistoriqueRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new ProfilesHistoriqueRepository($managerRegistryMock);
