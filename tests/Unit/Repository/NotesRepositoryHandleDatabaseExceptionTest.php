...
/**
 * [Description NotesRepositoryHandleDatabaseExceptionTest]
 */
class NotesRepositoryHandleDatabaseExceptionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repo = new NotesRepository($registry);
    }
    ...
    public function testNoDatabase(): void
    {
      ...
      /** @var \Doctrine\DBAL\Driver\Exception|\PHPUnit\Framework\MockObject\MockObject */
        ...
        $repo = new NotesRepository($managerRegistryMock);
