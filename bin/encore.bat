...
cls
if "%1"=="" (
    echo Erreur : Aucun paramÃ¨tre fourni.
...
if exist %LECTEUR_PATH%:\environnement\%PROJET%\ (
    goto :info
        ...
        echo [91m    _____ Le projet %PROJET% nâ€™a pas Ã©tÃ© trouvÃ©... _____[0m
    exit /b 1
)
...
@rem Laurent HADJADJ - 2024-05-24 v1.6.0 - Tests du lecteur par dÃ©faut
@rem Laurent HADJADJ - 2024-08-01 v1.6.1 - Correction de l'en-tÃªte sur 80 colonnes
@rem Laurent HADJADJ - 2024-08-28 v1.7.0 - Mise Ã  jour de nodejs en version 20.17.0 LTS
@rem Laurent HADJADJ - 2024-08-28 v1.7.0 - Passage du nom du projet en paramÃ¨tre
@rem Laurent HADJADJ - 2024-09-09 v1.7.1 - Mise Ã  jour nodejs en 20.17.1 LTS
