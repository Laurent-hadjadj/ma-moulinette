...
@title PostgreSQL 18.1 - vacuum - %VERSION%
...
echo Analyse et maintenance PostgreSQL 18.1...
"%PG_BIN%\vacuumdb.exe" -U postgres --all --analyze-in-stages --missing-stats-only
"%PG_BIN%\vacuumdb.exe" -U postgres --all --analyze-only
