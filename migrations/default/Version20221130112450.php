 ...
 */
final class Version20221130112450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ma_moulinette (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, version VARCHAR(8) NOT NULL, date_version DATETIME NOT NULL, date_enregistrement DATETIME NOT NULL)');
        ...
        $this->addSql('CREATE TABLE portefeuille (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(32) NOT NULL, equipe VARCHAR(32) NOT NULL, liste CLOB NOT NULL --(DC2Type:json)
        ...
        $this->addSql('CREATE TABLE properties (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type VARCHAR(255) NOT NULL, projet_bd INTEGER NOT NULL, projet_sonar INTEGER NOT NULL, profil_bd INTEGER NOT NULL, profil_sonar INTEGER NOT NULL, date_creation DATETIME NOT NULL, date_modification_projet DATETIME DEFAULT NULL, date_modification_profil DATETIME DEFAULT NULL)');
        $this->addSql('CREATE TABLE tags (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, maven_key VARCHAR(128) NOT NULL, name VARCHAR(64) NOT NULL, tags CLOB NOT NULL --(DC2Type:json)
        , visibility VARCHAR(8) NOT NULL, date_enregistrement DATETIME NOT NULL)');
        $this->addSql('CREATE TABLE utilisateur (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, prenom VARCHAR(32) NOT NULL, nom VARCHAR(64) NOT NULL, avatar VARCHAR(128) DEFAULT NULL, courriel VARCHAR(320) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , equipe CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(64) NOT NULL, actif BOOLEAN DEFAULT 0 NOT NULL, date_modification DATETIME DEFAULT NULL, date_enregistrement DATETIME NOT NULL)');
