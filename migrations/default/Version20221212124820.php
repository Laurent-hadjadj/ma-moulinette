 ...
 */
final class Version20221212124820 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE batch_traitement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, demarrage VARCHAR(16) NOT NULL, resultat BOOLEAN NOT NULL, titre VARCHAR(32) NOT NULL, portefeuille VARCHAR(32) NOT NULL, nombre_projet INTEGER NOT NULL, responsable VARCHAR(128) NOT NULL, debut_traitement DATETIME DEFAULT NULL, fin_traitement DATETIME DEFAULT NULL, date_enregistrement DATETIME NOT NULL)');
    }
